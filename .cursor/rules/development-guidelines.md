...
_This document is the standing reference for all development on this project. Any AI coding agent (Cursor, etc.) working on this repo should read and follow this before generating code, and should re-check it when a task touches an area it governs._
...
- **Inline comments**: only where the _why_ isn't obvious from the code itself. Don't narrate what the code obviously does.
...
- Small, atomic commits with clear messages describing _what_ and _why_.
